...
public class MDFoodValues {
    ...
    public static final FoodProperties BAT_WING = new FoodProperties.Builder().nutrition(1).saturationMod(0.1f).effect(() -> new MobEffectInstance(MobEffects.CONFUSION, 600, 0), 0.4F).fast().build();
    public static final FoodProperties SMOKED_BAT_WING = new FoodProperties.Builder().nutrition(3).saturationMod(0.15f).fast().build();
    ...
    public static final FoodProperties IMPROVISED_BARBECUE_STICK = new FoodProperties.Builder().nutrition(7).saturationMod(0.7f).fast().build();
    ...
    public static final FoodProperties INSECT_STEW = new FoodProperties.Builder().nutrition(8).saturationMod(0.45f).effect(() -> new MobEffectInstance(ModEffects.NOURISHMENT.get(), 1200, 0), 1.0F).build();
    ...
    public static final FoodProperties SPIDER_LEG = new FoodProperties.Builder().nutrition(6).saturationMod(0.2f).build();
    public static final FoodProperties BAKED_SPIDER_LEG = new FoodProperties.Builder().nutrition(10).saturationMod(0.2f).build();
    public static final FoodProperties PLATE_OF_GLAZED_ARACHNID_LIMBS = new FoodProperties.Builder().nutrition(12).saturationMod(0.8f).effect(() -> new MobEffectInstance(ModEffects.NOURISHMENT.get(), 6000, 0), 1.0F).build();

    public static final FoodProperties FAKE_MEATLOAF_MEAL = new FoodProperties.Builder().nutrition(8).saturationMod(0.65f).effect(() -> new MobEffectInstance(ModEffects.NOURISHMENT.get(), 1200, 0), 1.0F).build();
    public static final FoodProperties CAVE_HAMBURGER = new FoodProperties.Builder().nutrition(12).saturationMod(0.6f).build();

    public static final FoodProperties CRUNCHY_BAR = new FoodProperties.Builder().nutrition(7).saturationMod(0.45f).build();
    public static final FoodProperties NUTRITIONAL_BAR = new FoodProperties.Builder().nutrition(10).saturationMod(0.55f).effect(() -> new MobEffectInstance(ModEffects.NOURISHMENT.get(), 600, 0), 1.0F).build();
    public static final FoodProperties GOLDEN_NUTRITIONAL_BAR = new FoodProperties.Builder().nutrition(10).saturationMod(0.8f).effect(() -> new MobEffectInstance(ModEffects.NOURISHMENT.get(), 1200, 0), 1.0F).build();

    public static final FoodProperties TENTACLES_ON_A_STICK = new FoodProperties.Builder().nutrition(4).saturationMod(0.2f).fast().build();

    public static final FoodProperties SQUID = new FoodProperties.Builder().nutrition(3).saturationMod(0.15f).effect(() -> new MobEffectInstance(MobEffects.BLINDNESS, 600, 0), 0.4F).build();
    public static final FoodProperties GLOW_SQUID = new FoodProperties.Builder().nutrition(3).saturationMod(0.15f).effect(() -> new MobEffectInstance(MobEffects.GLOWING, 600, 0), 1f).build();
    public static final FoodProperties BAKED_SQUID = new FoodProperties.Builder().nutrition(6).saturationMod(0.4f).build();
    public static final FoodProperties TENTACLES = new FoodProperties.Builder().nutrition(1).saturationMod(0.05f).build();
    public static final FoodProperties BAKED_TENTACLES = new FoodProperties.Builder().nutrition(2).saturationMod(0.1f).fast().build();
