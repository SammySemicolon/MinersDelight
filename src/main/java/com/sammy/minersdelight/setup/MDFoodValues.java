...
public class MDFoodValues {
    ...
    public static final FoodProperties COPPER_CARROT = new FoodProperties.Builder().nutrition(3).saturationModifier(0.45f).effect(() -> new MobEffectInstance(MobEffects.POISON, 600, 0), 1f).build();
    ...
    public static final FoodProperties VEGAN_STEAK_AND_POTATOES = new FoodProperties.Builder().nutrition(12).saturationModifier(0.6f).effect(() -> new MobEffectInstance(ModEffects.NOURISHMENT, 3600, 0), 1.0F).build();

    public static final FoodProperties MOSS = new FoodProperties.Builder().nutrition(1).saturationModifier(0.05f).effect(() -> new MobEffectInstance(ModEffects.COMFORT, 200, 0), 1f).fast().build();
    ...
    public static final FoodProperties BAT_SOUP = new FoodProperties.Builder().nutrition(7).saturationModifier(0.45f).effect(() -> new MobEffectInstance(ModEffects.COMFORT, 3600, 0), 1.0F).build();
    ...
    public static final FoodProperties PLATE_OF_GLAZED_ARACHNID_LIMBS = new FoodProperties.Builder().nutrition(12).saturationModifier(0.8f).effect(() -> new MobEffectInstance(ModEffects.NOURISHMENT, 6000, 0), 1.0F).build();
    public static final FoodProperties ARTHROPOD = new FoodProperties.Builder().nutrition(3).saturationModifier(0.15f).effect(() -> new MobEffectInstance(MobEffects.CONFUSION, 600, 0), 0.4F).build();
    ...
    public static final FoodProperties SEASONED_ARTHROPODS = new FoodProperties.Builder().nutrition(14).saturationModifier(0.75f).effect(() -> new MobEffectInstance(ModEffects.NOURISHMENT, 6000, 0), 1.0F).build();

    public static final FoodProperties CRUNCHY_BAR = new FoodProperties.Builder().nutrition(7).saturationModifier(0.45f).build();
    public static final FoodProperties NUTRITIONAL_BAR = new FoodProperties.Builder().nutrition(10).saturationModifier(0.55f).effect(() -> new MobEffectInstance(ModEffects.NOURISHMENT, 600, 0), 1.0F).build();
    public static final FoodProperties GOLDEN_NUTRITIONAL_BAR = new FoodProperties.Builder().nutrition(12).saturationModifier(0.8f).effect(() -> new MobEffectInstance(ModEffects.NOURISHMENT, 1200, 0), 1.0F).build();
    ...
    public static final FoodProperties GLOW_INK_PASTA = new FoodProperties.Builder().nutrition(14).saturationModifier(1.1f).effect(() -> new MobEffectInstance(ModEffects.NOURISHMENT, 6000, 0), 1.0F).effect(() -> new MobEffectInstance(MobEffects.GLOWING, 1800, 0), 1.0F).build();
